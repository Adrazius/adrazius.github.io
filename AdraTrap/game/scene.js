...
function createLevel() {
    ...
    mat.emissiveColor = new BABYLON.Color3(255 / 255.0, 230 / 255.0, 205 / 255.0);
    mat.alpha = 0.5;
...
function initParticles() {
    ...
    // set the texture
    particles.particleTexture = new BABYLON.Texture("../AdraTrap/textures/dust.png", scene);
...
function createHazard() {
    cone = BABYLON.MeshBuilder.CreateCylinder("cone", { diameterTop: 0.2, tessellation: 4, diameterBottom: 1.5, height: 3 }, scene);
            ...
            if(player.intersectsMesh(colliders[i], true) && !player.isDead){
                ...
                if(colliders[i].tagName === "hazard"){
                    ...
                    setTimeout(function(){
                        ...
                        $('#totalScore').html('Ton score: ' + Math.round(score));
                    }, 1000);
                }
            }
        }
